...
#   POPULARITY_V2_ENABLED (default: true)
...
POPULARITY_V2_ENABLED="${POPULARITY_V2_ENABLED:-true}"
POPULARITY_HALF_LIFE_HOURS="${POPULARITY_HALF_LIFE_HOURS:-168}"
...
set_env_var "POPULARITY_V2_ENABLED" "$POPULARITY_V2_ENABLED"
set_env_var "POPULARITY_HALF_LIFE_HOURS" "$POPULARITY_HALF_LIFE_HOURS"
